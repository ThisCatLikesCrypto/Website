...
const MobileSidebar = function(){
    ...
    return (
        <div class={this.isstupid}>
            ...
            <AButton href="data" text="Data!"></AButton>&nbsp;
            ...
            <AButton href="specs" text="Tech Specs"></AButton>&nbsp;
            <AButton href="software" text="Software Setup"></AButton>&nbsp;
            <AButton href="downloads" text="dl Index"></AButton>&nbsp;
            <AButton href="directory" text="Crypto Links"></AButton>&nbsp;
            <AButton href="licence" text="Licence"></AButton>&nbsp;
            <AButton href="domains" text="Domains"></AButton>&nbsp;
