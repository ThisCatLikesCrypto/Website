...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    try {
        ...
        document.getElementById('infop1').innerHTML = "Please refresh the page. If this this issue persists, please create an issue on <a href='https://github.com/ThisCatLikesCrypto/Website'>https://github.com/ThisCatLikesCrypto/Website</a>";
